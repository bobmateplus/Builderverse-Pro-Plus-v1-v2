...
export const SpeakerXMarkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25L11.47 3.53a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53L6.75 15.75H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75zM12 12.75l1.5-1.5m2.25-2.25L21 4.5m-1.5 1.5l-1.5 1.5m-3.75 3.75l-1.5 1.5m2.25 2.25L21 19.5m-1.5-1.5l-1.5-1.5" />
    </svg>
);
...
export const ChatBubbleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a.75.75 0 01-1.06 0l-3.72-3.72h-3.522c-1.134 0-2.063-.923-2.063-2.062V10.608c0-.969.616-1.813 1.5-2.097m0 0A9.025 9.025 0 0112 5.25c2.433 0 4.653.964 6.25 2.56m-12.5 0v10.5c0 .597.234 1.17.654 1.591l.012.012L9.343 18.04a.75.75 0 01.53.22l.26.26a.75.75 0 001.06 0l.26-.26a.75.75 0 01.53-.22l2.655-2.655c.42-.42.654-.994.654-1.591V8.511m-12.5 0a9.028 9.028 0 00-6.25 2.56" />
    </svg>
);
...
// Fix: Add GlobeIcon component to resolve import error in EstimateDisplay.
export const GlobeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A11.953 11.953 0 0112 18.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 003 12c0-.778.099 1.533.284-2.253m0 0l-3.93-3.93" />
  </svg>
);

export const BriefcaseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.098a2.25 2.25 0 01-2.25 2.25h-13.5a2.25 2.25 0 01-2.25-2.25V14.15M16.5 18.75h-9" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 12.572A48.375 48.375 0 0012 12.122C7.362 12.122 3.12 12.44 2.25 12.572M12 12.122V3.75m0 8.372a48.372 48.372 0 005.824.253M12 12.122a48.372 48.372 0 01-5.824.253" />
    </svg>
);
...
export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 18.75a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.289 2.72a3 3 0 01-4.682-2.72 9.094 9.094 0 013.741-.479m-4.28 2.28a3 3 0 002.122 2.122M12 12a3 3 0 11-6 0 3 3 0 016 0z" />
...
export const BuilderAvatarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const Cog6ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75v.01M12 12v.01M12 14.25v.01M12 16.5a.75.75 0 100 1.5.75.75 0 000-1.5z" />
...
export const ShareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.05.588.08m-5.858 2.186a2.25 2.25 0 112.186 0M12 18a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5zm0 0v-2.25m0-2.25c.195.025.39.05.588.08m-5.858 2.186a2.25 2.25 0 112.186 0m-2.186 0A2.25 2.25 0 0112 15.75m2.186 0c.195.025.39.05.588.08m-5.858-2.186a2.25 2.25 0 100-2.186m0 0c.195.025.39.05.588.08m0-2.186a2.25 2.25 0 112.186 0m-2.186 0A2.25 2.25 0 0112 11.25m2.186 0c.195.025.39.05.588.08m-5.858 0a2.25 2.25 0 100 2.186m0 0c.195.025.39.05.588.08M12 6a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5zm0 0v2.25m0 2.25c.195.025.39.05.588.08m-5.858-2.186a2.25 2.25 0 112.186 0m-2.186 0A2.25 2.25 0 0112 8.25m2.186 0c.195.025.39.05.588.08" />
    </svg>
);
...
export const InstagramIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.585-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.585-.012-4.85-.07c-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.85s.012-3.584.07-4.85c.149-3.227 1.664-4.771 4.919-4.919C8.415 2.175 8.796 2.163 12 2.163zm0 1.44c-3.116 0-3.483.01-4.702.066-2.859.13-4.041 1.312-4.17 4.17C3.07 9.05 3.06 9.418 3.06 12s.01 2.95.066 4.169c.13 2.859 1.312 4.041 4.17 4.17 1.22.056 1.587.066 4.702.066s3.483-.01 4.702-.066c2.859-.13 4.041-1.312 4.17-4.17.056-1.22.066-1.587.066-4.702s-.01-3.483-.066-4.702c-.13-2.859-1.312-4.041-4.17-4.17C15.483 3.613 15.116 3.603 12 3.603z" />
        <path d="M12 7.297c-2.598 0-4.703 2.105-4.703 4.703s2.105 4.703 4.703 4.703 4.703-2.105 4.703-4.703S14.598 7.297 12 7.297zm0 7.766c-1.69 0-3.062-1.373-3.062-3.062s1.373-3.062 3.062-3.062 3.062 1.373 3.062 3.062-1.373 3.062-3.062 3.062z" />
...
export const CreditCardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h6m3-5.25H21.75m-3-5.25H21.75m-3 0V3.75c0-.621-.504-1.125-1.125-1.125H5.625c-.621 0-1.125.504-1.125 1.125v4.5m16.5 0v8.25c0 .621-.504 1.125-1.125 1.125H5.625a1.125 1.125 0 01-1.125-1.125V8.25m16.5 0H2.25" />
    </svg>
);
